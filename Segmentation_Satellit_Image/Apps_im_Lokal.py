...
background_image_path = 'C:/Users/marti/Desktop/neueProg/webapps/dom.jpg'
...
with col2:
    ...
    selected_model_path = "C:/Users/marti/Desktop/neueProg/webapps/" + selected_model_name
    selected_model = load_model(selected_model_path, compile=False)  # Move this line here
    ...
    if uploaded_file is not None:
        ...
        if st.checkbox("Compare two models"):
            ...
            second_selected_model_path = "C:/Users/marti/Desktop/neueProg/webapps" + second_selected_model_name
            second_model = load_model(second_selected_model_path, compile=False)
